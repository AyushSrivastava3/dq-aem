...
@Component(
    ...
    property = {"process.label=Send Email Notification Delete Page"}
)
public class CustomStepToSendEmailNode implements WorkflowProcess {

    private static final Logger LOG = LoggerFactory.getLogger(CustomStepToSendEmailNode.class);
    ...
    public void execute(WorkItem item, WorkflowSession wfsession, MetaDataMap args) throws WorkflowException {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("nirbhaipanchakarla1@gmail.com", "gftwivyqafogslrl"));
